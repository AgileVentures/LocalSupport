...
Feature: As a member of the public visiting a partner site
  ...
  I would like to hide and display sections of the page on request
  Tracker story ID: https://www.pivotaltracker.com/story/show/149069421

  Scenario Outline: See markers for do-it volunteer ops on the map and form
    ...
    Given I visit the embedded index page
  ...
  Scenario: See opportunities open in new window when clicked
    ...
    Given the following volunteer opportunities exist:
      ...
      | Office Support     | Help with printing and copying. | Office Primer            | local  |
    Given I visit the embedded index page
    Then I should open opportunity in a new windows when clicked from the infowindow:
      | Cats Are Us | Office Primer |

  Scenario: See only the map container and search form rendered in the body
    ...
    Given I visit the embedded index page
    Then I should see the map container element on the page
