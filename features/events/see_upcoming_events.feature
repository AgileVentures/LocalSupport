Feature: List the upcoming events
  ...
  Background: Events have been added to the database
    ...
    Given the following events exist:
      ...
      | My first event | Good for everyone                  | Cats Are Us   | 2030-10-20          | 2030-10-20          | 10:40      | 10:50    |
      | An Event today | Testing the calendar functionality | Office Primer | today               | today               | 11:00      | 11:00    |
