...
# FactoryBot.create(:organisation, name: 'fiendish-bare', address: nil, postcode: nil)
...
#   before :all do
#     FactoryBot.create(:organisation, name: 'fiendish-all', address: nil, postcode: nil)
#   end
# end
...
describe 'database cleaner' do
  # before :each aka before gets cleaned up, before :all does not
  before :each do
    FactoryBot.create(:organisation, name: 'fiendish-all')
  end
  it 'it block gets cleaned up' do
    FactoryBot.create(:organisation, name: 'fiendish-it')
  end
  describe 'inner describe' do
    it 'with it block cleaned up too' do
      FactoryBot.create(:organisation, name: 'fiendish-inner')
    end
  end
end
